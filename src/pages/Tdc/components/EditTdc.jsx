...
const EditTdc = () => {
    ...
    const item = useSelector(state => state.tdcs.item)   
    ...
    const submitHandle = event => {       
        ...
        if(item.id)
        {
          dispatch(crudActions.SET_UPDATE('TDCS_ADD','tdcs',item,'lista'))            
        }else{
          dispatch(crudActions.SET_ADD('TDCS_ADD','tdcs',item,'lista'))           
        }   
