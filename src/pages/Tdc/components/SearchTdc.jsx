...
const SearchTdc = () => {
    ...
    const { total }= useSelector(state => state.tdcs)
    ...
    const submitHandle = event => {       
      ...
      iok.value = value
      iok.prop  = prop
      dispatch(crudActions.GET_SEARCH('TDCS_DATA','tdcs',iok))      
     }   
    return (                                        
      <Card>          
      <Row>
        ...
        <Col md={2}> 
        <p className="mt-3 ml-3" >{ total || 0 } TDCS</p>          
        </Col>   
      </Row>
      </Card>               
    );
};
export default SearchTdc;
